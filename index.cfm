...
<div class="bg-blue-500">
    ...
    <div class="text-6xl m-6"><cfoutput>#titleMessage#</cfoutput></div>
        <a href="/"
           class="m-6 h-12 bg-green-500 hover:bg-green-400 text-white font-bold py-2 px-4 border-b-4 border-green-700 hover:border-green-500 rounded">
            back home
        </a>
    </div>
    <cfset Goals = CreateObject("Component", "cfc.goals")/>
    <cfset list = Goals.ListGoals()/>
    <div class="mx-4 w-2/3 flex flex-row pb-32">
    <cfoutput>
        <cfloop array="#list#" index="goals">
            <a href="/goals/tasks.cfm?slug=#goals.slug#">
                <div class="max-w-sm bg-white rounded overflow-hidden shadow-lg mx-4 ">
